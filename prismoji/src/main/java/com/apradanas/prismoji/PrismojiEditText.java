...
public class PrismojiEditText extends AppCompatEditText {
    private int emojiSize;

    public PrismojiEditText(final Context context) {
        this(context, null);
    }

    public PrismojiEditText(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
