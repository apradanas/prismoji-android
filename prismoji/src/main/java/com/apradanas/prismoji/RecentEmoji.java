...
public interface RecentEmoji {
    /**
     * returns recent emojis. Could be loaded from a database, shared preferences or just hard
     * coded.<br>
    ...
    /**
     * should add the emoji to the recent ones. After calling this method, {@link
     * #getRecentEmojis()} should return the emoji that was just added
     *
     * @since 0.2.0
     */
